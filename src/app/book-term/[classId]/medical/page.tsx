...
export default function TermMedicalInfoPage() {
    const router = useRouter();
    const { state, classTypeRecord, setMedicalInfo, setEmergencyContact } = useTermBooking();
    ...
    const onSubmit = (data: FormData) => {
        ...
        if (!skipQuestionnaire) {
            router.push(`/book-term/${state.classId}/questionnaire`);
        } else {
