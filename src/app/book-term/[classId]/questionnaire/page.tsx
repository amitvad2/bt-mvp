...
export default function TermQuestionnairePage() {
    const router = useRouter();
    const { state, setQuestionnaire } = useTermBooking();

    const initialQuestionnaire = state.questionnaire || (state.student !== 'self' && state.student ? state.student.questionnaire : undefined);
    ...
    const onSubmit = (data: Questionnaire) => {
        ...
        router.push(`/book-term/${state.classId}/terms`);
    };
